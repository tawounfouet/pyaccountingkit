# OHADA - Plan comptable 2017

> Source PDF : `OHADA-Plan-comptable-2017.pdf`  
> Pages PDF : 32  
> Méthode de conversion : PyMuPDF text-layer extraction  
> Politique : source-first ; aucune correction sémantique silencieuse.  
...
[NB - Annexe de l’acte uniforme relatif au droit comptable et à l’information financière adopté
le 26 janvier 2017]
...
- 1133 Réserves consécutives à l’octroi de subventions d’inves-tissement
- 1134 Réserves des valeurs mobilières donnant accès au capital

Plan des comptes 2017 1
...
- 1985 Provisions pour droits à réduction ou avantage en nature (chèques cadeau,
cartes de fidélité...)
...
- 2847 Amortissements des agencements et aménagements du matériel et des actifs
biologiques
...
- 2937 Dépréciations des bâtiments industriels, agricoles et commerciaux mis en
concession
...
- 2947 Dépréciations des agencements et aménagements du matériel et des actifs
biologiques
...
• 462 Associés [2], comptes courants
- 4621 Principal
- 4626 Intérêts courus
• 463 Associés [2], opérations faites en commun et GIE
- 4631 Opérations courantes
- 4636 Intérêts courus
• 465 Associés [2], dividendes à payer
...
- 4813 Versements restant à effectuer sur titres de participation et titres immobilisés
non libérés
...
• 545 Avoirs d’or et autres métaux précieux [4]
...
• 634 Redevances pour brevets, licences, logiciels, concessions et droits et valeurs
similaires
...
- 6772 Mali provenant d’attribution gratuite d’actions au personnel salarié et aux
dirigeants
...
- 6798 Autres charges pour dépréciations et provisions pour risques à court terme
financières
...
Plan des comptes 2017 26

<!-- Page PDF 27 -->

www.droit-afrique.com OHADA

• 726 Immobilisations financières [9]
...
- 7798 Sur autres charges pour dépréciations et provisions pour risques à court terme
financières
...
• 849 Reprises de charges pour dépréciations et provisions pour risques à court terme
HAO
...
[1] Pièces, barres, lingots, louis d’or et autres métaux précieux (argent, diamant…) acquis et
que l’entité a l’intention de conserver de manière durable.

[2] Le terme « associés » englobe les « actionnaires » et les « membres ».

[3] Créer des sous comptes distinguant les immobilisations corporel-les des incorporelles.

[4] Pièces, barres, louis d’or et autres métaux précieux (argent, diamant…) acquis en vue
d’une cession à court terme. Ils jouent donc le rôle d’instruments de trésorerie.

[5] À l’exception des achats effectués avec les entités du groupe.

[6] L’entité peut créer des sous comptes pour les frais accessoires : douane, fret, assurance
sur achats, commissions, courtages sur achats, frais de transit, et autres frais accessoires.

[7] À l’exclusion des ventes faites à des entités du groupe.

[8] À inscrire au compte 706 si ces produits correspondent à une activité principale de
l’entité.
...
Ce sont des traits de repères de reconnaissance des comptes communs qui sont
indépendants des classes de comptes. Le numéro d’un compte comprend au maximum
quatre chiffres dont la position a une signification :

1) Le premier chiffre du numéro d’un compte désigne la classe d’appartenance dudit
compte. Exemple : 57 veut dire que le compte appartient à la classe 5. Ainsi :
• un numéro de compte qui comprend deux chiffres correspond au compte principal.
Exemple Compte 10 ;

Plan des comptes 2017 31

<!-- Page PDF 32 -->

www.droit-afrique.com OHADA

• un numéro de compte à trois chiffres renvoie à un compte divisionnaire. Exemple : le
compte « 101 Capital social » ;
• un numéro de compte à quatre chiffres renvoie à un sous compte. Exemple : le compte «
- **1011** - Capitaux souscrits non appelés ».

2) La terminaison 9 des comptes à deux chiffres. Deux cas sont à envisager :
• s’il s’agit d’un compte du bilan (classe 1 à 5) : la terminaison 9 a pour rôle d’identifier les
dépréciations provisionnées de la classe correspondante. Exemple : le compte 19
(provisions pour risques et charges), le compte 39 (dépréciations des stocks et encours
de production)
• s’il s’agit d’un compte de classes 6 et 7 : la terminaison 9 joue un rôle similaire au
précédent dans la mesure où elle se rapporte à l’opération concernant les provisions.
Exemple : le compte 69 dotations aux provisions et aux dépréciations, 79 reprises de
provisions, de dépréciations et autres.

3) La terminaison 9 dans les comptes à trois chiffres et plus sont à distinguer selon deux
cas :
• le chiffre 9, en troisième ou en quatrième position pour l’ensemble des classes, est le
solde inversé des opérations couvertes par le compte de niveau immédiatement
supérieur et classées dans les subdivisions se terminant par 1 à 8. Exemple : le compte
6059
• la nature des comptes de catégories. Exemple : le compte 6049

Cette logique n’est pas valable pour les comptes de la classe 2.

4) La terminaison 1 à 8 dans les comptes à trois chiffres et plus : elles servent à détailler les
opérations subordonnées au niveau immédiatement supérieur. Dans les comptes de gestion
d’activité ordinaire (classes 6 et 7), la terminaison 8 regroupe les opérations autres que
celles prévues dans les comptes de même niveau et dont la terminaison va de 1 à 7.
Exemple : le compte 758 veut dire « produit divers », le compte 668 veut dire « autres
charges sociales ».

5) La terminaison 3 dans 603 et 73 identifie les variations de stock des biens achetés et des
biens produits par l’entreprise.

6) La terminaison 0 n’a aucune signification dans le référentiel comptable OHADA.

Plan des comptes 2017 32
