...
Le MVP définit notamment `JournalEntry + JournalLine + Account + AccountingPeriod` comme données canoniques et traite grand livre, balances et états financiers comme projections calculées. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*

Il impose également l'immutabilité des écritures postées et la correction par reversal puis nouvelle écriture. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
Une comparaison structurelle EBNL/SYSCOHADA indique explicitement qu'un code identique n'est pas une preuve d'équivalence sémantique, que l'approbation automatique d'un crosswalk est désactivée et qu'une revue humaine peut être requise. *(→ source : [regulatory-accounting-data-framework](../../../resources/regulatory-accounting-data-framework/))*
...
CFA FRA pose explicitement cette règle comme condition de validité d'une écriture. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
CFA FRA contrôle explicitement qu'une écriture possède au moins deux lignes avant validation. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
CFA FRA distingue `DRAFT`, `VALIDATED`, `POSTED` et `REVERSED`. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
CFA FRA impose qu'une écriture `POSTED` soit immuable. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
CFA FRA exige que l'écriture originale demeure inchangée, qu'une écriture de contre-passation soit créée et que l'opération soit auditée. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
CFA FRA considère qu'une période fermée doit bloquer le posting. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
L'ouvrage doctrinal distingue explicitement le principe de séparation des périodes/exercices et relie la comptabilité périodique au rattachement des charges et produits à la période concernée. *(→ source : [Comptabilité Générale — Système français et normes IFRS](../../books/Comptabilite_Generale_Systeme_Francais_et_Normes_IFRS.md))*
...
Le rattachement est traité dans le corpus doctrinal comme un principe de modèle comptable et non comme une propriété mathématique de la partie double. *(→ source : [Comptabilité Générale — Système français et normes IFRS](../../books/Comptabilite_Generale_Systeme_Francais_et_Normes_IFRS.md))*
...
L'ouvrage situe la prudence parmi les principes qui caractérisent un type de comptabilité et l'oppose conceptuellement à une logique d'imprudence. *(→ source : [Comptabilité Générale — Système français et normes IFRS](../../books/Comptabilite_Generale_Systeme_Francais_et_Normes_IFRS.md))*
...
Le corpus doctrinal présente la continuité comme une hypothèse importante mais souligne qu'elle ne détermine pas à elle seule toutes les méthodes d'évaluation. *(→ source : [Comptabilité Générale — Système français et normes IFRS](../../books/Comptabilite_Generale_Systeme_Francais_et_Normes_IFRS.md))*
...
Le corpus doctrinal distingue les systèmes orientés coût et valeur et souligne l'existence de plusieurs concepts de coût. *(→ source : [Comptabilité Générale — Système français et normes IFRS](../../books/Comptabilite_Generale_Systeme_Francais_et_Normes_IFRS.md))*
...
CFA FRA exige un compte actif lors de la validation. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
CFA FRA inclut le journal actif parmi les contrôles de validation. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
CFA FRA exécute validation de période puis validation d'écriture avant passage à `POSTED`. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
CFA FRA précise que grand livre, balances et états financiers doivent être calculés depuis la source canonique plutôt que stockés comme copies indépendantes. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
pour son moteur interne de grand livre. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
dans la balance. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
avec des types d'écritures inclus différents. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
CFA FRA définit un workflow de clôture où les contrôles sont revus, les écritures de clôture générées, validées puis postées avant fermeture de la période. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
CFA FRA interdit le posting après fermeture. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
Le corpus doctrinal souligne d'ailleurs que la permanence n'est pas absolue. *(→ source : [Comptabilité Générale — Système français et normes IFRS](../../books/Comptabilite_Generale_Systeme_Francais_et_Normes_IFRS.md))*
...
Le dataset de comparaison OHADA étudié désactive l'équivalence sémantique automatique fondée sur le code seul. *(→ source : [regulatory-accounting-data-framework](../../../resources/regulatory-accounting-data-framework/))*
...
CFA FRA prévoit d'ailleurs une chaîne candidate -> suggestion -> validation humaine pour le mapping. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
CFA FRA distingue ces types et conserve la validation. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
CFA FRA impose l'usage de `Decimal` pour éviter les erreurs financières liées aux floats. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
CFA FRA importe le FEC après parsing, contrôles, mapping et normalisation, puis crée des écritures postées. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
...
comme clé fonctionnelle d'idempotence. *(→ source : [CFA FRA — Conception et MVP](../../../resources/cfa_fra_django_mvp_sprint_7/docs/CFA_FRA_DJANGO_DOCUMENT_CONCEPTION_TECHNICO_FONCTIONNELLE.md))*
